...
///// An object that encapsulates all identity provider authentication events.
//final class AuthenticationTask<P: IdentityProvider> {
//    let provider: P
//    let context: AuthenticationError<P>.Context
//    let completionHandler: (AuthenticationError<P>?) -> Void
//
//    init(provider: P, authenticationType: AuthenticationError<P>.Context.AuthenticationType, completionHandler: @escaping (AuthenticationError<P>?) -> Void) {
//        self.provider = provider
//        self.context = AuthenticationError.Context(provider: provider, authenticationType: authenticationType)
...
//            break
//        case .reauthenticate:
//            provider.reauthenticate { [unowned self] (result, error) in
//                if let error = error as NSError? {
//                    self.completionHandler(.other(error.localizedDescription, self.context))
//                }
//                else {
...
//}
//
///// This should be an NSOperation.
//final class ProfileChangeTask {
//    let authenticatedUser: User
//    let profileChangeType: ProfileChangeError.Context.ProfileChangeType
//    let completion: ProfileChangeHandler
//
//    init(authenticatedUser: User, profileChangeType: ProfileChangeError.Context.ProfileChangeType, completion: @escaping ProfileChangeHandler) {
...
//
//    func resume() {
//        switch profileChangeType {
//        case .email(let email):
//            authenticatedUser.updateEmail(to: email) { [unowned authenticatedUser] (error) in
//                guard let error = error else {
//                    self.completion(.success(true))
//                    return
//                }
//
//                let context = ProfileChangeError.Context(authenticatedUser: authenticatedUser, profileChangeType: self.profileChangeType)
//                self.handleResponseError(error, context: context, completion: self.completion)
//            }
//
//        case .password(let password):
//            authenticatedUser.updatePassword(to: password) { [unowned authenticatedUser] (error) in
//                guard let error = error else {
//                    self.completion(.success(true))
//                    return
//                }
...
//    }
//
//    private func handleResponseError(_ error: Error, context: ProfileChangeError.Context, completion: @escaping ProfileChangeHandler) {
//        if let error = error as NSError? {
